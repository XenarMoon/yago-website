import { 
  ...
  Music, ShieldAlert, GraduationCap, Smartphone, Lock, Brain, ArrowRight,
  Check, Star, Award
} from 'lucide-react';
  ...
  return (
    <div className="bg-[#0A0A0A] text-white">
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="bg-[#0A0A0A]/80 rounded-2xl p-10 border border-[#D4AF37]/20">
              <h3 className="text-[#D4AF37] mb-6">The Problem</h3>
            ...
            <div className="bg-white rounded-2xl p-10 shadow-2xl">
              <h3 className="text-[#0A0A0A] mb-6">YAGO Solves All of It</h3>
      ...
      <section className="py-32 bg-gradient-to-b from-[#0F1C2E] to-[#0A0A0A]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-[#F5F5F5] mb-4">Premium Benefits</h2>
      ...
      <section className="py-32 bg-[#0A0A0A]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300">Three simple steps to effortless living</p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center">
              <div className="text-center">
                ...
                <h3 className="text-[#F5F5F5] mb-3">1. Ask Anything</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-[#F5F5F5] mb-3">2. AI Processes</h3>
                <p className="text-gray-400">
              ...
              <div className="text-center">
                ...
                <h3 className="text-[#F5F5F5] mb-3">3. Done</h3>
                <p className="text-gray-400">
      ...
      <section className="py-32 bg-gradient-to-b from-[#0A0A0A] to-[#0F1C2E]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-[#F5F5F5] mb-4">Everything You Need</h2>
            <p className="text-gray-300">One assistant for your entire lifestyle</p>
          </div>
      ...
      <section className="py-32 bg-[#0A0A0A] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-[#F5F5F5] mb-6">The First AI Lifestyle SuperApp</h2>
      ...
      <section className="py-32 bg-gradient-to-br from-[#0A0A0A] via-[#1a1410] to-[#0A0A0A] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-[#D4AF37] mb-6">Lifetime Unlimited Access</h2>
            ...
            <button className="px-12 py-5 bg-gradient-to-r from-[#D4AF37] to-[#FFD700] text-[#0A0A0A] rounded-full shadow-2xl shadow-[#D4AF37]/50 hover:shadow-[#D4AF37]/70 transition-all duration-300 transform hover:scale-105">
      ...
      <section className="py-32 bg-white text-[#0A0A0A]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="mb-4">Real Stories, Real Results</h2>
            <p className="text-gray-600">See how YAGO transforms everyday moments</p>
          </div>
      ...
      <section className="py-32 bg-white text-[#0A0A0A]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600">Everything you need to know about YAGO</p>
          </div>
      ...
      <footer className="bg-[#0A0A0A] border-t border-[#D4AF37]/20 py-16">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="text-[#D4AF37] mb-4">YAGO</div>
              <p className="text-gray-400">
